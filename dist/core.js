...
var LoadGame = function LoadGame() {
  ...
  loader.add("blade_js", "./src/scripts/Blade_new.js").add("slice_js", "./src/scripts/SliceLayer.js").add("blade_tex", "./src/images/blade.png").add("bunny", "./src/images/bunny_ss.json").load(function (l, res) {
